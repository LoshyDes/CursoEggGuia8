...
public class EjercicioExtra1 {
    ...
    public static void main(String[] args) {
         ...
         * que 0.
         *
         * d) Método obtenerRaices(): llama a tieneRaices() y si devolvió́
         ...
         * solución posible.
         *
         * f) Método calcular(): éste método llamará tieneRaices() y a
         * tieneRaíz(), y mostrará por pantalla las posibles soluciones que
         * tiene nuestra ecuación con los métodos obtenerRaices() o
         * obtenerRaiz(), según lo que devuelvan nuestros métodos y en caso de
